...
In case of broken configuration, the Shield Wizard internal data used to generate this repository is in [\`${SHIELD_WIZARD_DATA_FILE}\`](${SHIELD_WIZARD_DATA_FILE}).

Generated by Shield Wizard commit: ${version.commit || '(unknown)'}
