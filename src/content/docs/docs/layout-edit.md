...
description: Guide and tips for editing the physical and keymap layouts in Shield Wizard.
---
...
If you're importing from VIA/VIAL/QMK, Shield Wizard might parse and use the electrical matrix as the keymap layout, which in some cases may create suboptimal keymaps. You should select the keys in Shield Wizard and use the move buttons in the Keymap Layout area to rearrange the keys.
